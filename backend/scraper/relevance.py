...
CS_TITLE_KW = re.compile(
    ...
    r"sistem\s?(müh|yönet|admin|uzman|destek|analist)|systems?\s?(admin|engineer|analyst|architect)|"
    ...
    r"\bit\b.*?(uzman|yönet|manager|müdür|support|destek|direktör|supervisor|specialist|engineer|mühend|network|proje|auditor|analyst)|"
