...
// Mirrors the wrapper the loaded dashboard uses, so swapping this out does not shift
// anything. It renders inside AppShell, which already supplies the main element, the
// page texture and the padding.
